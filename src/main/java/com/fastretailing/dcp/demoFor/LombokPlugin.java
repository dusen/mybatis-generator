...
public class LombokPlugin extends PluginAdapter {
    ...
    public boolean modelBaseRecordClassGenerated(TopLevelClass topLevelClass,
        ...
        if (topLevelClass.getSuperClass() != null) {
            addEqualsAndHashCode(topLevelClass);
            addBaseRecordClassToString(topLevelClass);
        }
        return true;
    }
    ...
    private void addEqualsAndHashCode(TopLevelClass topLevelClass) {
        topLevelClass.addImportedType(Annotations.Equals_And_Hash_Code.javaType);
        topLevelClass.addAnnotation(Annotations.Equals_And_Hash_Code.name);
    }
    
    private void addBaseRecordClassToString(TopLevelClass topLevelClass) {
        topLevelClass.addImportedType(Annotations.SUB_CLASS_TO_STRING.javaType);
        topLevelClass.addAnnotation(Annotations.SUB_CLASS_TO_STRING.name);
    }
    ...
    private enum Annotations {
        ...
        SUB_CLASS_TO_STRING("subClassToString","@ToString(callSuper = true)","lombok.ToString"),
        Equals_And_Hash_Code("equalsAndHashCode","@EqualsAndHashCode(callSuper = true)","lombok.EqualsAndHashCode");
